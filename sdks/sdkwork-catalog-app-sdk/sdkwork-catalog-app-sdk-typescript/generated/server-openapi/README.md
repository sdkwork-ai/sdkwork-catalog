...
```bash
npm install @sdkwork/catalog-app-sdk
# or
yarn add @sdkwork/catalog-app-sdk
# or
pnpm add @sdkwork/catalog-app-sdk
```

## Quick Start

```typescript
import { SdkworkAppClient } from '@sdkwork/catalog-app-sdk';
